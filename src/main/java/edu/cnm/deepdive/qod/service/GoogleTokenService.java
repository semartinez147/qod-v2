  ...
  public OAuth2Authentication loadAuthentication(String token)
    ...
    if (idToken != null) {
      ...
      String oauthKey = payload
          .getSubject(); // TODO Get any additional neeed info from payload for current user.
      ...
      Authentication base = new UsernamePasswordAuthenticationToken(oauthKey, token,
          grants); // TODO Use user object retrieved from user service instead of oauth key.
